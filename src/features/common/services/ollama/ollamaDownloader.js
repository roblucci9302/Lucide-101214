/**
 * OllamaDownloader - Handles file downloads with retry logic and checksum verification
 */
const https = require('https');
const crypto = require('crypto');
const { EventEmitter } = require('events');

class OllamaDownloader extends EventEmitter {
    constructor() {
        super();
        this.serviceName = 'OllamaDownloader';
    }
